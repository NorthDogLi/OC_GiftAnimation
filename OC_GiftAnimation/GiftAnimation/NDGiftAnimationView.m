...
- (void)setCurrentGift:(NDGiftModel *)currentGift {
    ...
    _nameLabel.text = _currentGift.user.nickname;
...
- (NSAttributedString *)getGiftName {
    ...
    NSMutableAttributedString *str2 = [[NSMutableAttributedString alloc] initWithString:[NSString stringWithFormat:@"  %@", _currentGift.gift.name]];
...
- (void)layoutSubviews {
    ...
    _backgroupView.frame = CGRectMake(8, 0, 176, self.frame.size.height);
    NDBezier(_backgroupView, UIRectCornerAllCorners, self.frame.size.height / 2);
    
    _headImageView.frame = CGRectMake(3, 3, 34, 34);
    NDViewRadius(_headImageView, 34/2);
    
    _nameLabel.frame = CGRectMake(CGRectGetMaxX(_headImageView.frame)+2, 2, 88, 18);
    
    _giftLabel.frame = CGRectMake(_nameLabel.frame.origin.x, CGRectGetMaxY(_nameLabel.frame), 88, 18);
    
    _giftImageView.frame = CGRectMake(CGRectGetMaxX(_nameLabel.frame)+3, 0, 40, 40);
    
    // CGRectGetMaxX(_giftImageView.frame)
    _animationImgView.frame = CGRectMake(CGRectGetMaxX(_backgroupView.frame), 7, 32, 25);
...
- (void)setUI {
    ...
    _backgroupView.backgroundColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:0.15];
